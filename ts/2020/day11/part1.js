...
function checkNewRows() {
  ...
  for (let i = 0; i < rows.length; i++) {
    ...
    for (let j = 0; j < row.length; j++) {
      ...
      surrCells[0] = getCell(x,y-1);
      surrCells[1] = getCell(x,y+1);
      surrCells[2] = getCell(x-1,y);
      surrCells[3] = getCell(x+1,y);
      surrCells[4] = getCell(x-1,y-1);
      surrCells[5] = getCell(x+1,y-1);
      surrCells[6] = getCell(x-1,y+1);
      surrCells[7] = getCell(x+1,y+1);
